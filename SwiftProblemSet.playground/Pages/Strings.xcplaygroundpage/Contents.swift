...
if word .contains("ham") {
    print("Ham is in the building")
} else {
    print("Where's the ham at?")
}

//: ### Exercise 6
//: Declare two strings and then use a single operator to concatenate them together to create a third string.
let firstString: String = "Giggity Giggity "
let secondString: String = "Goo"
let partyString: String = firstString + secondString
//: ### Exercise 7
...
print("Josie has $\(numOfPennies / 100).\(numOfPennies % 100) ")
//: ### Exercise 9
...
print(weeklyEarningsString.replacingOccurrences(of: "X", with: "\((averageRent/averageMonthlyEarnings)*100)"))
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
